...
import { getPostsofParticularGroup, filterPostsByContentAndIdGroup } from "@/apis/forum";
    ...
    <div className="flex flex-col justify-center items-center gap-4 min-w-[70%] py-5">
      <div className="flex items-center bg-gray-900 rounded-full px-4 py-2 w-full max-w-md">
        <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-4.35-4.35m1.8-4.8a7.5 7.5 0 11-15 0 7.5 7.5 0 0115 0z"></path>
        </svg>
        <input
          type="text"
